...
import SuraDetails.SuraDetailsActivity
...
class QuranFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = ActivityQuranFragmentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initSuraRecycler() {
        adapter = SuraAdapter(suraList)
        binding.rvSura.adapter = adapter
        adapter.onItemClickListener = SuraAdapter.OnItemClickListener { title, position ->
            StartSuraDetailsActivity(title, position)
    ...
    private fun StartSuraDetailsActivity(title: String, position: Int) {
        ...
        intent.putExtra(Constants.suraIndex, position)
        intent.putExtra(Constants.suraTitle, title)
